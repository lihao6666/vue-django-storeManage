...
class Organization(models.Model):
    ...
    area_name = models.CharField(max_length=20, verbose_name='区域')
    orga_status = models.IntegerField(choices=ORGA_STATUS_CHOICES, default=0, verbose_name='组织状态')
...
class Meterage(models.Model):
    ...
    meterage_status = models.IntegerField(choices=METERAGE_STATUS_CHOICES, default=0, verbose_name='计量单位状态')
