    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='区域状态')),
            ],
            options={
                'verbose_name': '区域',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('center_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='中心状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='客户状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dpm_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='部门状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='物料状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='物料类别状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meterage_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='计量单位状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_name', models.CharField(max_length=20, verbose_name='区域')),
                ('orga_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='组织状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='角色状态')),
                ('role_power', models.CharField(max_length=60, null=True, verbose_name='角色权限')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supply_status', models.IntegerField(choices=[(0, '停用'), (1, '启用')], default=1, verbose_name='供应商状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_belong_center_iden', models.CharField(max_length=20, null=True, verbose_name='所属中心的编号')),
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orga_total_ware_house', to='base.Organization')),
            ],
            options={
                'verbose_name': '总仓',
            },
