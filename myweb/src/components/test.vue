  ...
  <div>
    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="req_pur_type" sortable label="需求类型" align="center"></el-table-column>
        <el-table-column prop="req_pur_from" sortable label="申请部门" align="center"></el-table-column>
        ...
        <el-table-column prop="req_pur_creator" sortable label="创建人" align="center"></el-table-column>
  ...
  methods: {
    getData () {
      ...
      axios.get('/test').then(function (res) {
        ...
        _this.pageTotal = res.data.pageTotal || 50
      }).catch(function (err) {
        console.log(err)
      })
    },
