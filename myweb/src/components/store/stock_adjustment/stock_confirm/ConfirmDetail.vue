  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-lx-cascades"></i> 转库盘点明细
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      >
        ...
        <el-table-column prop="trd_meterage" sortable label="单位" :filters="trd_meterageSet"
                         :filter-method="filter" align="center"></el-table-column>
        <el-table-column prop="trd_num" sortable label="账面数量" align="center"></el-table-column>
        <el-table-column prop="trd_num" sortable label="盘点数量" align="center">
        ...
        <el-table-column  sortable label="差异数量" align="center"></el-table-column>
        <el-table-column prop="trd_present_num" sortable label="调整单价" align="center"></el-table-column>
          <el-table-column prop="trd_present_num" sortable label="调整金额" align="center"></el-table-column>
    ...
    <el-dialog title="选择物料" :visible.sync="addVisible" width="90%" append-to-body>
      <ConfirmDetailAdd @add="addPrd" :tableHas="tableData" :formadd="formadd" :ifhasorga="ifhasorga" :ifhasfrom="ifhasfrom"></ConfirmDetailAdd>
    </el-dialog>
  </div>
</template>
...
import ConfirmDetailAdd from './ConfirmDetailAdd'
