  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-select v-model="formadd.str_from" placeholder="请选择仓库" :disabled="ifhasfrom">
      ...
      >
        ...
        <el-table-column prop="trd_meterage" sortable label="单位" :filters="trd_meterageSet"
                         :filter-method="filter" align="center"></el-table-column>
        <el-table-column prop="trd_present_num" sortable label="账面数量" align="center"></el-table-column>
      </el-table>
      <!-- 分页 -->
